...
test('validateGridValues.execute(sudokuGrid) for grid [[0, 2, 4, 0], [1, 0, 0, 3], [4, 0, 0, 2], [0, 1, 3, 0]] should be true', function () {
	'use strict';
	var gridData = [[0, 2, 4, 0], [1, 0, 0, 3], [4, 0, 0, 2], [0, 1, 3, 0]],
		...
		validateGridValues = app.usecase.validateGridValues.create();
